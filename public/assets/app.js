...
let state = { products: {}, parties: [], orders: [], salesmen: [], vardana: { materials: {}, recipes: {}, productions: [] }, meta: {} };
...
function renderAll() {
  updateAuthUi(); renderDropdowns(); renderKpis(); renderCart(); renderRecentOrders(); renderInventory(); renderOrders(); renderMasters(); renderTargets(); renderReports(); renderVardana();
