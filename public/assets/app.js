...
function renderDropdowns() {
  ...
  if ($('closingBalanceProduct')) preserveSelect($('closingBalanceProduct'), vardanaProductOptions);
...
function updateClosingBalancePreview() {
  ...
  const product = $('closingBalanceProduct').value;
...
function initEvents() {
  ...
  $('drawerBtn').addEventListener('click', () => document.body.classList.toggle('nav-open')); $('globalSearch').addEventListener('input', renderAll); ['filterSalesman','filterStatus','filterShortage','inventoryCategoryFilter','inventoryStockFilter','inventorySortFilter','inventoryHistoryProduct','inventoryHistoryFrom','inventoryHistoryTo','reportFrom','reportTo','reportSalesman','reportParty','reportProduct','targetSalesmanFilter','targetCategoryFilter','targetProductFilter','vardanaRecipeProduct','vardanaProductionProduct','closingBalanceProduct'].forEach(id => { if ($(id)) $(id).addEventListener('change', renderAll); }); if ($('vardanaProductionQty')) $('vardanaProductionQty').addEventListener('input', renderVardanaPreview); if ($('closingBalanceQty')) $('closingBalanceQty').addEventListener('input', updateClosingBalancePreview);
